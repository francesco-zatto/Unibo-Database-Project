...
import project.model.Contratto;

public class ContrattiTable implements Table<Contratto, String> {

    private static final String TABLE_NAME = "Contratti";
    private final Connection connection; 

    public ContrattiTable(final Connection connection) {
    ...
    @Override
    public Optional<Contratto> findByPrimaryKey(String primaryKey) {
        // TODO Auto-generated method stub
    ...
    @Override
    public boolean save(Contratto value) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'save'");
    }

    @Override
    public boolean update(Contratto updatedValue) {
        // TODO Auto-generated method stub
